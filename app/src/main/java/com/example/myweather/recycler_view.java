...
public class recycler_view extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // timeTv = findViewById(R.id.timeTv);
        ...
        // ktm
        String kathmanduWeatherApiUrl = "https://api.openweathermap.org/data/2.5/weather?q=Kathmandu&appid=b4a01341ce29d08a73814e4539e0859c";
        ...
        ArrayList<WeatherModel> tasks = new ArrayList<WeatherModel>();
        ...
        String forecastApiUrl = "https://api.openweathermap.org/data/2.5/forecast?q=Kathmandu&appid=b4a01341ce29d08a73814e4539e0859c";
        ...
        locationEt.setOnEditorActionListener(new TextView.OnEditorActionListener() {
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if ((event != null && (event.getKeyCode() == KeyEvent.KEYCODE_ENTER)) || (actionId == EditorInfo.IME_ACTION_DONE)) {
                    ...
                    String forecastApiUrl = "https://api.openweathermap.org/data/2.5/forecast?q=" + location + "&appid=b4a01341ce29d08a73814e4539e0859c";
                    String weatherApiUrl = "https://api.openweathermap.org/data/2.5/weather?q=" + location + "&appid=b4a01341ce29d08a73814e4539e0859c";
    ...
    public void jsonArrayDecode(String jsonData, RecyclerViewAdapter adapter) {
        ...
        try {
            ...
            for (int i = 0; i < listArray.length(); i++) {
                ...
                data.add(new WeatherModel(date,time, temp, imageUrl));
            }
    ...
    private String convertTimestampToTime(long dt) {
